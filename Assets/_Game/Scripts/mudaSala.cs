...
public class mudaSala : MonoBehaviour {
    ...
    void Start()
    {
		...
		if (Application.platform == RuntimePlatform.Android) {
			dataPath = System.IO.Path.Combine (Application.persistentDataPath, "comportamento_mudaSala.xml");
			//Debug.Log(dataPath);
	...
	void Clicked()
    {
		...
		if(backgroundFarmacia == (GameObject.Find("local").GetComponent<SpriteRenderer>().sprite)){
			...
			deFarmaciaParaQuarto();
			comportamento c = new comportamento();
			c.descricao = "Foi para o quarto";
			c.objeto = "Seta direita";
			c.hora = System.DateTime.Now;
			cc.comportamentos.Add (c);
			SaveXML (dataPath, cc);
